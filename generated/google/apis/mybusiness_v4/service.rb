  ...
  module Apis
    module MybusinessV4
      ...
      class MyBusinessService < Google::Apis::Core::BaseService
        ...
        # Deletes a location.
        # <aside class="note"><b>Note:</b> If this location has an associated Google+
        # page, as indicated by a `plus_page_id` in the
        # LocationKey, it cannot be deleted
        # using the API; instead, use the [Google My
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_account_locations(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # Transfers a location from one account to another. To perform a transfer, a
        # user must be an owner of the account the location is currently associated
        # with and at least a manager of the destination account. Returns the
        # Location with its new resource name.
        # @param [String] name
        ...
        #   also the maximum supported number of media items.
        # @param [String] page_token
